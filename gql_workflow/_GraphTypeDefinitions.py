...
class WorkflowStateUserGQLModel:
    ...
    async def state(
        ...
        result = await WorkflowStateGQLModel.resolve_reference(
...
class AuthorizationGQLModel:
    ...
    @strawberryA.field(
        description="""Proxy role types attached to this authorization"""
    )
...
class Mutation:
    ...
    async def authorization_insert(
        self, info: strawberryA.types.Info, authorization: AuthorizationInsertGQLModel
    ...
    async def authorization_add_user(
        self, info: strawberryA.types.Info, authorization: AuthorizationAddUserGQLModel
    ) -> AuthorizationResultGQLModel:
        loader = getLoaders(info).authorizationusers
    ...
    async def authorization_remove_user(
        self, info: strawberryA.types.Info, authorization: AuthorizationAddUserGQLModel
    ) -> AuthorizationResultGQLModel:
        loader = getLoaders(info).authorizationusers
        existing = await loader.filter_by(
    ...
    @strawberryA.mutation(
        description="""Adds or updates a group at the authorization"""
    )
    async def authorization_add_group(
        self, info: strawberryA.types.Info, authorization: AuthorizationAddGroupGQLModel
    ) -> AuthorizationResultGQLModel:
        loader = getLoaders(info).authorizationgroups
        existing = await loader.filter_by(
            authorization_id=authorization.authorization_id,
    ...
    async def authorization_add_role(
        self, info: strawberryA.types.Info, authorization: AuthorizationAddRoleGQLModel
    ) -> AuthorizationResultGQLModel:
    ...
    async def workflow_insert(
        self, info: strawberryA.types.Info, workflow: WorkflowInsertGQLModel
    ...
    async def workflow_update(
        self, info: strawberryA.types.Info, workflow: WorkflowUpdateGQLModel
    ) -> WorkflowResultGQLModel:
        loader = getLoaders(info).workflows
    ...
    async def workflow_state_insert(
        self, info: strawberryA.types.Info, state: WorkflowStateInsertGQLModel
    ...
    async def workflow_state_update(
        self, info: strawberryA.types.Info, state: WorkflowStateUpdateGQLModel
    ) -> WorkflowStateResultGQLModel:
        loader = getLoaders(info).workflowstates
    ...
    async def workflow_transition_insert(
        self, info: strawberryA.types.Info, state: WorkflowTransitionInsertGQLModel
    ...
    async def workflow_transition_update(
        self, info: strawberryA.types.Info, state: WorkflowTransitionUpdateGQLModel
    ) -> WorkflowTransitionResultGQLModel:
        loader = getLoaders(info).workflowtransitions
        row = await loader.update(state)
        result = WorkflowTransitionResultGQLModel()
