...
# AuthorizationUserGQLModel = Annotated[
#     "AuthorizationUserGQLModel", strawberry.lazy(".authorizationUserGQLModel")
# ]
# AuthorizationGroupGQLModel = Annotated[
#     "AuthorizationGroupGQLModel", strawberry.lazy(".authorizationGroupGQLModel")
# ]
# AuthorizationRoleTypeGQLModel = Annotated[
#     "AuthorizationRoleTypeGQLModel", strawberry.lazy(".authorizationRoleTypeGQLModel")
# ]
